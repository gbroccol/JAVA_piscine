...
4. launch program
    ```diff
        ...
        java -jar target/images-to-char-printer.jar --white= --black=
        java -jar target/images-to-char-printer.jar --white=.
        java -jar target/images-to-char-printer.jar --black=0
        java -jar target/images-to-char-printer.jar --white= --black=  --filePath=./it.bmp
