...
public class User {
    ...
    public User(String login, String password, List<Chatroom> createdRooms, List<Chatroom> activeChatroom) {
        this(0l, login, password, createdRooms, activeChatroom);
    }

    public User(Long userId, String login, String password) {
        this(userId, login, password, null, null);
    }
