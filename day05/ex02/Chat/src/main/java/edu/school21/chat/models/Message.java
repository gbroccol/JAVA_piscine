...
public class Message {
    ...
    public Message(User author, Chatroom chatroom, String text, LocalDateTime localDateTime) {
        this(0l, author, chatroom, text, localDateTime);
    }
    ...
    public String toString() {
        return Program.ANSI_YELLOW + "Message : {" +
                "\n\tid = " + messageId +
                "\n\tauthor = " + author +
                "\n\tchatroom = " + chatroom +
                "\n\ttext = \"" + text + '\"' +
